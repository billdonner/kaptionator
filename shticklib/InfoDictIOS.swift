...
public struct IO {
   ...
   private typealias DTSKR = ((_ data:Data?, _ response:URLResponse?, _ nserror:Error?) -> (Swift.Void))
    ...
    static func prepareStickers( pack:String,title:String,imagepath:String, caption:String, options:StickerMakingOptions) throws -> SharedCE {
        do {
    ...
    static func checkForFileVariant(_ ce:SharedCE,_ variant:String) -> Bool {
