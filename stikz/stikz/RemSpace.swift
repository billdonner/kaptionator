...
public     static func itemAt(_ idx:Int) -> RemoteAsset {
        return raz [idx]
    }
public     static func itemCount() -> Int { return raz.count }
    
 public    static func addasset(ra:RemoteAsset){
        raz.append(ra)
    }
    // scan till ltight match and remove
 public    static func remove(ra:RemoteAsset){
        var idx = 0
        for val in raz {
...
public struct Manifest {
    ...
    //
  public   static func parseData(_ data:Data, baseURL: String,completion:  ((Int,String,[RemoteAsset]) -> (Swift.Void))) {
    ...
    public static func loadJSONFromLocal(url:URL?,completion:((Int,String,[RemoteAsset]) -> (Swift.Void))?) {
   ...
   public  static func loadJSONFromURL(url:URL?,completion:((Int,String,[RemoteAsset]) -> (Swift.Void))?) {
        guard let url = url else {
