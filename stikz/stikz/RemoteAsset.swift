...
public     let remoteurl :String
 ...
 public    let options:StickerMakingOptions
    ...
    //
    //
 public    func copyWithNewOptions(stickerOptions: StickerMakingOptions) -> RemoteAsset {
    ...
    public init(localurl:URL,options:StickerMakingOptions,title:String="",thumb:String="") {
 ...
 public    init(pack:String,title:String,thumb:String, remoteurl:String?,localpath:String?, options:StickerMakingOptions) {
        self.pack = pack
  ...
  public   static func loadFromITunesSharing(   completion:((Int,String,[RemoteAsset]) -> (Swift.Void))?) {
